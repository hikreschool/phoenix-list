...
class ChecklistTableViewController: UITableViewController {
    ...
    let checklist = ChecklistItemData()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let circleView = cell.viewWithTag(1001)!
        ...
        let itemFromList = checklist.listItems[indexPath.row]
    ...
    override func tableView(_ tableView: UITableView,
        ...
        _ = checklist.listItems[indexPath.row]
        ...
        if let cell = tableView.cellForRow(at: indexPath) {
            ...
            checklist.listItems[indexPath.row].isChecked = !checklist.listItems[indexPath.row].isChecked
    ...
    func configureCheckmark(for cell: UITableViewCell, at indexPath: IndexPath) {
        ...
        let checklistIsChecked = checklist.listItems[indexPath.row]
    ...
    func checkIfAllItemsChecked() {
        ...
        for item in self.checklist.listItems {
    ...
    func addNewCheckListItem() {
        ...
        let saveAction = UIAlertAction(title: "Add", style: UIAlertAction.Style.default, handler: { alert -> Void in
            ...
            if let newItem = firstTextField.text {
                ...
                self.checklist.listItems.append(newChecklistItem)
